// src/lib.rs
/*
 * Core library for ConsulConnect
 */
...
#[derive(Debug)]
pub struct ConsulConnectProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ConsulConnectProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ConsulConnect processing");
    
    let mut processor = ConsulConnectProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ConsulConnectProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ConsulConnectProcessor::new(false);
